      ...
      {({ theme }) => (
        <Link data-index={index} href={`/manga/${id}`}>
          ...
          >
            ...
            <div
              className="flex-shrink-1 flex flex-col flex-nowrap ml-2"
              style={{ minWidth: "calc(50% - 20px)" }}
            >
              <span
                className={classname(
              ...
              >
                <p className="flex-shrink-1 min-w-0 text-ellipsis">
                  {description
                    ? description.en
  ...
  return (
    <div className="flex flex-col flex-nowrap hidden_scroll">
      ...
      <Swipper
        ...
        className="flex flex-row flex-nowrap p-1 overflow-x-auto slider_wrapper hidden_scroll scrollbar-none snap-start snap-proximity"
      >
        {mangas.length > 0
        ...
        {loading
          ? array.map((_, index) => <MangaSlider key={index} index={index} />)
          : null}
      </Swipper>
