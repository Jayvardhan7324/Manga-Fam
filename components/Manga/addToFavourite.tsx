          ...
          >
            <button
              ...
              className={classname(
                ...
                "fill-white border border-solid border-primary-color transition-colors hover:bg-transparent",
                theme === "LIGHT" ? "hover:text-primary-color hover:fill-primary-color" : "",
              )}
            >
              <span className={classname(
                  "w-5 h-5 mr-2 fill-inherit",
                )}
              >
                <Favourite/>
              </span>
